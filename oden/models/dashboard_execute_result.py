...
class DashboardExecuteResult(object):
    ...
    openapi_types = {
        ...
        'module_name': 'str',
        'module_type': 'str',
        'range': 'DashboardExecuteResultRange',
        'filters_applied': 'dict(str, object)',
        'columns': 'list[DashboardColumnSpec]',
    ...
    def __init__(self, module_id=None, module_name=None, module_type=None, range=None, filters_applied=None, columns=None, rows=None, error=None, local_vars_configuration=None):  # noqa: E501
        """DashboardExecuteResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def module_id(self):
        """Gets the module_id of this DashboardExecuteResult.  # noqa: E501


        :return: The module_id of this DashboardExecuteResult.  # noqa: E501
        :rtype: str
        """
    ...
    def module_id(self, module_id):
        """Sets the module_id of this DashboardExecuteResult.


        :param module_id: The module_id of this DashboardExecuteResult.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and module_id is None:  # noqa: E501
    ...
    def module_name(self):
        """Gets the module_name of this DashboardExecuteResult.  # noqa: E501


        :return: The module_name of this DashboardExecuteResult.  # noqa: E501
        :rtype: str
        """
    ...
    def module_name(self, module_name):
        """Sets the module_name of this DashboardExecuteResult.


        :param module_name: The module_name of this DashboardExecuteResult.  # noqa: E501
        :type: str
        """
    ...
    def module_type(self):
        """Gets the module_type of this DashboardExecuteResult.  # noqa: E501

        The module's stored visualization (e.g. `table`, `line_chart`, `bar_chart`). Type label only — does not change the response shape.   # noqa: E501

        :return: The module_type of this DashboardExecuteResult.  # noqa: E501
        :rtype: str
        """
    ...
    def module_type(self, module_type):
        """Sets the module_type of this DashboardExecuteResult.

        The module's stored visualization (e.g. `table`, `line_chart`, `bar_chart`). Type label only — does not change the response shape.   # noqa: E501

        :param module_type: The module_type of this DashboardExecuteResult.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and module_type is None:  # noqa: E501
    ...
    @property
    def range(self):
        """Gets the range of this DashboardExecuteResult.  # noqa: E501


        :return: The range of this DashboardExecuteResult.  # noqa: E501
        :rtype: DashboardExecuteResultRange
        """
        return self._range

    @range.setter
    def range(self, range):
        """Sets the range of this DashboardExecuteResult.


        :param range: The range of this DashboardExecuteResult.  # noqa: E501
        :type: DashboardExecuteResultRange
        """
    ...
    def filters_applied(self):
        """Gets the filters_applied of this DashboardExecuteResult.  # noqa: E501

        Echo of the filter dimensions that were applied, resolved to human-readable values where possible (e.g. line names instead of IDs).   # noqa: E501

        :return: The filters_applied of this DashboardExecuteResult.  # noqa: E501
        :rtype: dict(str, object)
        """
        return self._filters_applied

    @filters_applied.setter
    def filters_applied(self, filters_applied):
        """Sets the filters_applied of this DashboardExecuteResult.

        Echo of the filter dimensions that were applied, resolved to human-readable values where possible (e.g. line names instead of IDs).   # noqa: E501

        :param filters_applied: The filters_applied of this DashboardExecuteResult.  # noqa: E501
    ...
    @property
    def columns(self):
        """Gets the columns of this DashboardExecuteResult.  # noqa: E501

        Column metadata. `type` is derived from the first non-null cell in the column. Null when the module errored.   # noqa: E501

        :return: The columns of this DashboardExecuteResult.  # noqa: E501
        :rtype: list[DashboardColumnSpec]
        """
        return self._columns

    @columns.setter
    def columns(self, columns):
        """Sets the columns of this DashboardExecuteResult.

        Column metadata. `type` is derived from the first non-null cell in the column. Null when the module errored.   # noqa: E501

        :param columns: The columns of this DashboardExecuteResult.  # noqa: E501
        :type: list[DashboardColumnSpec]
        """
    ...
    @property
    def rows(self):
        """Gets the rows of this DashboardExecuteResult.  # noqa: E501

        Row data as objects keyed by column name (not positional arrays). Values are typed JSON natively. Null when the module errored.   # noqa: E501

        :return: The rows of this DashboardExecuteResult.  # noqa: E501
    ...
    @rows.setter
    def rows(self, rows):
        """Sets the rows of this DashboardExecuteResult.

        Row data as objects keyed by column name (not positional arrays). Values are typed JSON natively. Null when the module errored.   # noqa: E501

        :param rows: The rows of this DashboardExecuteResult.  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this DashboardExecuteResult.  # noqa: E501

        Set to a short message when the module failed to parse or execute. Null on success.   # noqa: E501

        :return: The error of this DashboardExecuteResult.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this DashboardExecuteResult.

        Set to a short message when the module failed to parse or execute. Null on success.   # noqa: E501

        :param error: The error of this DashboardExecuteResult.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DashboardExecuteResult):
            return False
