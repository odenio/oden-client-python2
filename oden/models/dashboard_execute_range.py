...
class DashboardExecuteRange(object):
    ...
    def __init__(self, start=None, end=None, anchor=None, offset=None, timezone=None, local_vars_configuration=None):  # noqa: E501
        """DashboardExecuteRange - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def start(self):
        """Gets the start of this DashboardExecuteRange.  # noqa: E501


        :return: The start of this DashboardExecuteRange.  # noqa: E501
        :rtype: datetime
        """
        return self._start
    ...
    def start(self, start):
        """Sets the start of this DashboardExecuteRange.


        :param start: The start of this DashboardExecuteRange.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def end(self):
        """Gets the end of this DashboardExecuteRange.  # noqa: E501


        :return: The end of this DashboardExecuteRange.  # noqa: E501
        :rtype: datetime
        """
        return self._end
    ...
    @end.setter
    def end(self, end):
        """Sets the end of this DashboardExecuteRange.


        :param end: The end of this DashboardExecuteRange.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def anchor(self):
        """Gets the anchor of this DashboardExecuteRange.  # noqa: E501

        Anchor expression for a relative range, e.g. `now`.  # noqa: E501

        :return: The anchor of this DashboardExecuteRange.  # noqa: E501
        :rtype: str
        """
        return self._anchor
    ...
    def anchor(self, anchor):
        """Sets the anchor of this DashboardExecuteRange.

        Anchor expression for a relative range, e.g. `now`.  # noqa: E501

        :param anchor: The anchor of this DashboardExecuteRange.  # noqa: E501
        :type: str
        """
    ...
    @property
    def offset(self):
        """Gets the offset of this DashboardExecuteRange.  # noqa: E501

        Offset expression for a relative range, e.g. `-7D`.  # noqa: E501

        :return: The offset of this DashboardExecuteRange.  # noqa: E501
        :rtype: str
        """
        return self._offset
    ...
    def offset(self, offset):
        """Sets the offset of this DashboardExecuteRange.

        Offset expression for a relative range, e.g. `-7D`.  # noqa: E501

        :param offset: The offset of this DashboardExecuteRange.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timezone(self):
        """Gets the timezone of this DashboardExecuteRange.  # noqa: E501

        IANA timezone identifier (defaults to UTC).  # noqa: E501

        :return: The timezone of this DashboardExecuteRange.  # noqa: E501
        :rtype: str
        """
    ...
    def timezone(self, timezone):
        """Sets the timezone of this DashboardExecuteRange.

        IANA timezone identifier (defaults to UTC).  # noqa: E501

        :param timezone: The timezone of this DashboardExecuteRange.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DashboardExecuteRange):
            return False
