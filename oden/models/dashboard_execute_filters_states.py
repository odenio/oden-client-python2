...
class DashboardExecuteFiltersStates(object):
    ...
    openapi_types = {
        ...
        'state_category_and_reasons': 'list[DashboardExecuteFiltersStatesStateCategoryAndReasons]'
    }

    attribute_map = {
        'state_types': 'state_types',
        'state_category_and_reasons': 'state_category_and_reasons'
    }

    def __init__(self, state_types=None, state_category_and_reasons=None, local_vars_configuration=None):  # noqa: E501
        """DashboardExecuteFiltersStates - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._state_types = None
        self._state_category_and_reasons = None
        self.discriminator = None

        if state_types is not None:
            self.state_types = state_types
        if state_category_and_reasons is not None:
            self.state_category_and_reasons = state_category_and_reasons

    @property
    def state_types(self):
        """Gets the state_types of this DashboardExecuteFiltersStates.  # noqa: E501


        :return: The state_types of this DashboardExecuteFiltersStates.  # noqa: E501
        :rtype: list[str]
        """
        return self._state_types

    @state_types.setter
    def state_types(self, state_types):
        """Sets the state_types of this DashboardExecuteFiltersStates.


        :param state_types: The state_types of this DashboardExecuteFiltersStates.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def state_category_and_reasons(self):
        """Gets the state_category_and_reasons of this DashboardExecuteFiltersStates.  # noqa: E501


        :return: The state_category_and_reasons of this DashboardExecuteFiltersStates.  # noqa: E501
        :rtype: list[DashboardExecuteFiltersStatesStateCategoryAndReasons]
        """
        return self._state_category_and_reasons

    @state_category_and_reasons.setter
    def state_category_and_reasons(self, state_category_and_reasons):
        """Sets the state_category_and_reasons of this DashboardExecuteFiltersStates.


        :param state_category_and_reasons: The state_category_and_reasons of this DashboardExecuteFiltersStates.  # noqa: E501
        :type: list[DashboardExecuteFiltersStatesStateCategoryAndReasons]
        """

        self._state_category_and_reasons = state_category_and_reasons
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DashboardExecuteFiltersStates):
            return False
