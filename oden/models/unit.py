...
class Unit(object):
    ...
    def __init__(self, id=None, symbol=None, name=None, kind_of_quantity=None, local_vars_configuration=None):  # noqa: E501
        ...
        if name is not None:
            self.name = name
        if kind_of_quantity is not None:
            self.kind_of_quantity = kind_of_quantity
    ...
    def kind_of_quantity(self):
        """Gets the kind_of_quantity of this Unit.  # noqa: E501


        :return: The kind_of_quantity of this Unit.  # noqa: E501
        :rtype: str
        """
        return self._kind_of_quantity

    @kind_of_quantity.setter
    def kind_of_quantity(self, kind_of_quantity):
        """Sets the kind_of_quantity of this Unit.


        :param kind_of_quantity: The kind_of_quantity of this Unit.  # noqa: E501
        :type: str
        """
