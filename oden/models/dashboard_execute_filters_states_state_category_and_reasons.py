...
class DashboardExecuteFiltersStatesStateCategoryAndReasons(object):
    ...
    def __init__(self, state_category=None, state_reason=None, local_vars_configuration=None):  # noqa: E501
        """DashboardExecuteFiltersStatesStateCategoryAndReasons - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._state_category = None
    ...
    def state_category(self):
        """Gets the state_category of this DashboardExecuteFiltersStatesStateCategoryAndReasons.  # noqa: E501


        :return: The state_category of this DashboardExecuteFiltersStatesStateCategoryAndReasons.  # noqa: E501
        :rtype: int
        """
        return self._state_category

    @state_category.setter
    def state_category(self, state_category):
        """Sets the state_category of this DashboardExecuteFiltersStatesStateCategoryAndReasons.


        :param state_category: The state_category of this DashboardExecuteFiltersStatesStateCategoryAndReasons.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and state_category is None:  # noqa: E501
            raise ValueError("Invalid value for `state_category`, must not be `None`")  # noqa: E501

        self._state_category = state_category

    @property
    def state_reason(self):
        """Gets the state_reason of this DashboardExecuteFiltersStatesStateCategoryAndReasons.  # noqa: E501


        :return: The state_reason of this DashboardExecuteFiltersStatesStateCategoryAndReasons.  # noqa: E501
        :rtype: str
        """
    ...
    def state_reason(self, state_reason):
        """Sets the state_reason of this DashboardExecuteFiltersStatesStateCategoryAndReasons.


        :param state_reason: The state_reason of this DashboardExecuteFiltersStatesStateCategoryAndReasons.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DashboardExecuteFiltersStatesStateCategoryAndReasons):
            return False
