...
class StateCategoryDetail(object):
    ...
    def __init__(self, id=None, name=None, type=None, active=None, builtin=None, local_vars_configuration=None):  # noqa: E501
        """StateCategoryDetail - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this StateCategoryDetail.  # noqa: E501


        :return: The id of this StateCategoryDetail.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this StateCategoryDetail.


        :param id: The id of this StateCategoryDetail.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this StateCategoryDetail.  # noqa: E501


        :return: The name of this StateCategoryDetail.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StateCategoryDetail.


        :param name: The name of this StateCategoryDetail.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this StateCategoryDetail.  # noqa: E501


        :return: The type of this StateCategoryDetail.  # noqa: E501
        :rtype: StateCategoryType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this StateCategoryDetail.


        :param type: The type of this StateCategoryDetail.  # noqa: E501
        :type: StateCategoryType
        """
    ...
    @property
    def active(self):
        """Gets the active of this StateCategoryDetail.  # noqa: E501


        :return: The active of this StateCategoryDetail.  # noqa: E501
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this StateCategoryDetail.


        :param active: The active of this StateCategoryDetail.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def builtin(self):
        """Gets the builtin of this StateCategoryDetail.  # noqa: E501

        True for Oden's global categories, which have no organization and cannot be modified.  # noqa: E501

        :return: The builtin of this StateCategoryDetail.  # noqa: E501
        :rtype: bool
        """
    ...
    def builtin(self, builtin):
        """Sets the builtin of this StateCategoryDetail.

        True for Oden's global categories, which have no organization and cannot be modified.  # noqa: E501

        :param builtin: The builtin of this StateCategoryDetail.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StateCategoryDetail):
            return False
