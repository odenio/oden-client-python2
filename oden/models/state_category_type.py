...
class StateCategoryType(object):
    ...
    allowable_values = [UPTIME, SCRAPPING, PLANNED_DOWNTIME, UNPLANNED_DOWNTIME]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """StateCategoryType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StateCategoryType):
            return False
