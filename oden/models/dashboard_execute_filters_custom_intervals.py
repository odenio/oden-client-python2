...
class DashboardExecuteFiltersCustomIntervals(object):
    ...
    def __init__(self, type=None, value_contains=None, local_vars_configuration=None):  # noqa: E501
        """DashboardExecuteFiltersCustomIntervals - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this DashboardExecuteFiltersCustomIntervals.  # noqa: E501


        :return: The type of this DashboardExecuteFiltersCustomIntervals.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DashboardExecuteFiltersCustomIntervals.


        :param type: The type of this DashboardExecuteFiltersCustomIntervals.  # noqa: E501
        :type: str
        """
    ...
    def value_contains(self):
        """Gets the value_contains of this DashboardExecuteFiltersCustomIntervals.  # noqa: E501


        :return: The value_contains of this DashboardExecuteFiltersCustomIntervals.  # noqa: E501
        :rtype: str
        """
    ...
    def value_contains(self, value_contains):
        """Sets the value_contains of this DashboardExecuteFiltersCustomIntervals.


        :param value_contains: The value_contains of this DashboardExecuteFiltersCustomIntervals.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and value_contains is None:  # noqa: E501
            raise ValueError("Invalid value for `value_contains`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DashboardExecuteFiltersCustomIntervals):
            return False
