...
class DashboardExecuteFilters(object):
    ...
    openapi_types = {
        ...
        'product_attribute_value_ids': 'list[str]',
        'scrap_categories': 'list[str]',
        'states': 'DashboardExecuteFiltersStates',
        'custom_intervals': 'list[DashboardExecuteFiltersCustomIntervals]'
    }
    ...
    def __init__(self, lines=None, shifts=None, product_ids=None, product_attribute_value_ids=None, scrap_categories=None, states=None, custom_intervals=None, local_vars_configuration=None):  # noqa: E501
        """DashboardExecuteFilters - a model defined in OpenAPI"""  # noqa: E501
        ...
        self._product_attribute_value_ids = None
        self._scrap_categories = None
        self._states = None
        self._custom_intervals = None
        ...
        if product_attribute_value_ids is not None:
            self.product_attribute_value_ids = product_attribute_value_ids
        if scrap_categories is not None:
            self.scrap_categories = scrap_categories
    ...
    @property
    def lines(self):
        """Gets the lines of this DashboardExecuteFilters.  # noqa: E501

        Lines to restrict to. Each entry must supply `id`, `name`, or both; entries that supply neither are rejected. Other Line fields (factory, secondary_name, match) are not used here and are intentionally omitted so generated clients don't suggest them as inputs.   # noqa: E501

        :return: The lines of this DashboardExecuteFilters.  # noqa: E501
        :rtype: list[AnyOfAnyTypeAnyType]
        """
        return self._lines

    @lines.setter
    def lines(self, lines):
        """Sets the lines of this DashboardExecuteFilters.

        Lines to restrict to. Each entry must supply `id`, `name`, or both; entries that supply neither are rejected. Other Line fields (factory, secondary_name, match) are not used here and are intentionally omitted so generated clients don't suggest them as inputs.   # noqa: E501

        :param lines: The lines of this DashboardExecuteFilters.  # noqa: E501
        :type: list[AnyOfAnyTypeAnyType]
        """
    ...
    @property
    def shifts(self):
        """Gets the shifts of this DashboardExecuteFilters.  # noqa: E501


        :return: The shifts of this DashboardExecuteFilters.  # noqa: E501
        :rtype: list[int]
        """
        return self._shifts
    ...
    def shifts(self, shifts):
        """Sets the shifts of this DashboardExecuteFilters.


        :param shifts: The shifts of this DashboardExecuteFilters.  # noqa: E501
        :type: list[int]
        """
    ...
    def product_ids(self):
        """Gets the product_ids of this DashboardExecuteFilters.  # noqa: E501


        :return: The product_ids of this DashboardExecuteFilters.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def product_ids(self, product_ids):
        """Sets the product_ids of this DashboardExecuteFilters.


        :param product_ids: The product_ids of this DashboardExecuteFilters.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def product_attribute_value_ids(self):
        """Gets the product_attribute_value_ids of this DashboardExecuteFilters.  # noqa: E501


        :return: The product_attribute_value_ids of this DashboardExecuteFilters.  # noqa: E501
        :rtype: list[str]
        """
        return self._product_attribute_value_ids

    @product_attribute_value_ids.setter
    def product_attribute_value_ids(self, product_attribute_value_ids):
        """Sets the product_attribute_value_ids of this DashboardExecuteFilters.


        :param product_attribute_value_ids: The product_attribute_value_ids of this DashboardExecuteFilters.  # noqa: E501
        :type: list[str]
        """

        self._product_attribute_value_ids = product_attribute_value_ids

    @property
    def scrap_categories(self):
        """Gets the scrap_categories of this DashboardExecuteFilters.  # noqa: E501


        :return: The scrap_categories of this DashboardExecuteFilters.  # noqa: E501
        :rtype: list[str]
        """
        return self._scrap_categories

    @scrap_categories.setter
    def scrap_categories(self, scrap_categories):
        """Sets the scrap_categories of this DashboardExecuteFilters.


        :param scrap_categories: The scrap_categories of this DashboardExecuteFilters.  # noqa: E501
        :type: list[str]
        """

        self._scrap_categories = scrap_categories

    @property
    def states(self):
        """Gets the states of this DashboardExecuteFilters.  # noqa: E501


        :return: The states of this DashboardExecuteFilters.  # noqa: E501
        :rtype: DashboardExecuteFiltersStates
        """
        return self._states

    @states.setter
    def states(self, states):
        """Sets the states of this DashboardExecuteFilters.


        :param states: The states of this DashboardExecuteFilters.  # noqa: E501
        :type: DashboardExecuteFiltersStates
        """

        self._states = states

    @property
    def custom_intervals(self):
        """Gets the custom_intervals of this DashboardExecuteFilters.  # noqa: E501


        :return: The custom_intervals of this DashboardExecuteFilters.  # noqa: E501
        :rtype: list[DashboardExecuteFiltersCustomIntervals]
        """
        return self._custom_intervals

    @custom_intervals.setter
    def custom_intervals(self, custom_intervals):
        """Sets the custom_intervals of this DashboardExecuteFilters.


        :param custom_intervals: The custom_intervals of this DashboardExecuteFilters.  # noqa: E501
        :type: list[DashboardExecuteFiltersCustomIntervals]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DashboardExecuteFilters):
            return False
