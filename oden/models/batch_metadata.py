...
class BatchMetadata(object):
    ...
    def __init__(self, metadata_type=None, run=None, local_vars_configuration=None):  # noqa: E501
        """BatchMetadata - a model defined in OpenAPI"""  # noqa: E501
    ...
    def metadata_type(self):
        """Gets the metadata_type of this BatchMetadata.  # noqa: E501


        :return: The metadata_type of this BatchMetadata.  # noqa: E501
        :rtype: str
        """
    ...
    def metadata_type(self, metadata_type):
        """Sets the metadata_type of this BatchMetadata.
    ...
    @property
    def run(self):
        """Gets the run of this BatchMetadata.  # noqa: E501


        :return: The run of this BatchMetadata.  # noqa: E501
        :rtype: Interval
        """
        return self._run
    ...
    @run.setter
    def run(self, run):
        """Sets the run of this BatchMetadata.


        :param run: The run of this BatchMetadata.  # noqa: E501
        :type: Interval
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchMetadata):
            return False
