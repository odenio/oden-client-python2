...
class MaintenanceWorkOrdersApi(object):
    ...
    def delete_maintenance_work_order(self, maintenance_work_order, **kwargs):  # noqa: E501
        ...
        :param MaintenanceWorkOrder maintenance_work_order: (required)
    ...
    def delete_maintenance_work_order_with_http_info(self, maintenance_work_order, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[MaintenanceWorkOrder], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        body_params = None
        if 'maintenance_work_order' in local_var_params:
            body_params = local_var_params['maintenance_work_order']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            '/v2/maintenance_work_order/delete', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='list[MaintenanceWorkOrder]',  # noqa: E501
    ...
    def search_maintenance_work_orders_with_http_info(self, inline_object4, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/maintenance_work_order/search', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def set_maintenance_work_order_with_http_info(self, maintenance_work_order, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(MaintenanceWorkOrder, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/v2/maintenance_work_order/set', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
