...
class OQLApi(object):
    ...
    def v2_oql_query_post(self, oql_query, **kwargs):  # noqa: E501
        """v2_oql_query_post  # noqa: E501

        Run an OQL (Oden Query Language) query.  For reference on writing OQL queries, see:  [https://platform.oden.app/knowledge/how-do-i-write-queries-in-oden-query-language-oql](https://platform.oden.app/knowledge/how-do-i-write-queries-in-oden-query-language-oql)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_oql_query_post(oql_query, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param OQLQuery oql_query: (required)
        :param str format: Format of the response. Can be `json`, `jsonextended` or `csv`. If unspecified, defaults to `jsonextended`. 
        ...
        return self.v2_oql_query_post_with_http_info(oql_query, **kwargs)  # noqa: E501

    def v2_oql_query_post_with_http_info(self, oql_query, **kwargs):  # noqa: E501
        """v2_oql_query_post  # noqa: E501

        Run an OQL (Oden Query Language) query.  For reference on writing OQL queries, see:  [https://platform.oden.app/knowledge/how-do-i-write-queries-in-oden-query-language-oql](https://platform.oden.app/knowledge/how-do-i-write-queries-in-oden-query-language-oql)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_oql_query_post_with_http_info(oql_query, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method v2_oql_query_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'oql_query' is set
        if self.api_client.client_side_validation and ('oql_query' not in local_var_params or  # noqa: E501
                                                        local_var_params['oql_query'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `oql_query` when calling `v2_oql_query_post`")  # noqa: E501
        ...
        body_params = None
        if 'oql_query' in local_var_params:
            body_params = local_var_params['oql_query']
        # HTTP header `Accept`
