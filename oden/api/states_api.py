...
class StatesApi(object):
    ...
    def search_state_categories(self, state_category_search, **kwargs):  # noqa: E501
        """Search state categories  # noqa: E501

        Returns the state categories available to your organization, including Oden's built-in ones. Filter by `id` or `name`; omit both to list all. Built-in categories have no `organization` and cannot be modified.  `type` summarises how the platform treats time in the category: - `uptime`: producing good product - `scrapping`: running but not producing good product - `planned_downtime`, `unplanned_downtime`: not running   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_state_categories(state_category_search, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param StateCategorySearch state_category_search: (required)
        ...
        :return: list[StateCategoryDetail]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.search_state_categories_with_http_info(state_category_search, **kwargs)  # noqa: E501

    def search_state_categories_with_http_info(self, state_category_search, **kwargs):  # noqa: E501
        """Search state categories  # noqa: E501

        Returns the state categories available to your organization, including Oden's built-in ones. Filter by `id` or `name`; omit both to list all. Built-in categories have no `organization` and cannot be modified.  `type` summarises how the platform treats time in the category: - `uptime`: producing good product - `scrapping`: running but not producing good product - `planned_downtime`, `unplanned_downtime`: not running   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_state_categories_with_http_info(state_category_search, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[StateCategoryDetail], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method search_state_categories" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'state_category_search' is set
        if self.api_client.client_side_validation and ('state_category_search' not in local_var_params or  # noqa: E501
                                                        local_var_params['state_category_search'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `state_category_search` when calling `search_state_categories`")  # noqa: E501
        ...
        body_params = None
        if 'state_category_search' in local_var_params:
            body_params = local_var_params['state_category_search']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='list[StateCategoryDetail]',  # noqa: E501
    ...
    def search_state_reasons(self, state_reason_search, **kwargs):  # noqa: E501
        """Search state reasons on one or more lines  # noqa: E501

        Returns the state reasons defined on every line in `lines` (required; each by `id`, or by `name` plus `factory`), optionally restricted to one `category` (by `id` or `name`). Each result names its line, so one request can audit a whole fleet. Inactive reasons are included, with `active: false`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_state_reasons(state_reason_search, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param StateReasonSearch state_reason_search: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: list[StateReasonDetail]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.search_state_reasons_with_http_info(state_reason_search, **kwargs)  # noqa: E501

    def search_state_reasons_with_http_info(self, state_reason_search, **kwargs):  # noqa: E501
        """Search state reasons on one or more lines  # noqa: E501

        Returns the state reasons defined on every line in `lines` (required; each by `id`, or by `name` plus `factory`), optionally restricted to one `category` (by `id` or `name`). Each result names its line, so one request can audit a whole fleet. Inactive reasons are included, with `active: false`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_state_reasons_with_http_info(state_reason_search, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[StateReasonDetail], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_state_reasons" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'state_reason_search' is set
        if self.api_client.client_side_validation and ('state_reason_search' not in local_var_params or  # noqa: E501
                                                        local_var_params['state_reason_search'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `state_reason_search` when calling `search_state_reasons`")  # noqa: E501
        ...
        body_params = None
        if 'state_reason_search' in local_var_params:
            body_params = local_var_params['state_reason_search']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[StateReasonDetail]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def set_state_category(self, state_category_set, **kwargs):  # noqa: E501
        ...
        **Create** (no `id`): `name` and `type` are required. If a category with that `name` already exists for your organization and has the same `type`, it is returned unchanged; a different `type` is a 409.  **Update** (with `id`): fields you omit keep their current value. Built-in categories (no organization) cannot be updated.  Requires an organization admin token.   # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: StateCategoryDetail
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.set_state_category_with_http_info(state_category_set, **kwargs)  # noqa: E501

    def set_state_category_with_http_info(self, state_category_set, **kwargs):  # noqa: E501
        """Create or update a state category  # noqa: E501

        **Create** (no `id`): `name` and `type` are required. If a category with that `name` already exists for your organization and has the same `type`, it is returned unchanged; a different `type` is a 409.  **Update** (with `id`): fields you omit keep their current value. Built-in categories (no organization) cannot be updated.  Requires an organization admin token.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_state_category_with_http_info(state_category_set, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(StateCategoryDetail, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method set_state_category" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'state_category_set' is set
        if self.api_client.client_side_validation and ('state_category_set' not in local_var_params or  # noqa: E501
                                                        local_var_params['state_category_set'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `state_category_set` when calling `set_state_category`")  # noqa: E501
        ...
        body_params = None
        if 'state_category_set' in local_var_params:
            body_params = local_var_params['state_category_set']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='StateCategoryDetail',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def set_state_reasons(self, state_reason_set, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.set_state_reasons_with_http_info(state_reason_set, **kwargs)  # noqa: E501

    def set_state_reasons_with_http_info(self, state_reason_set, **kwargs):  # noqa: E501
        """Create a state reason on one or more lines  # noqa: E501

        Ensures the reason `name` exists under `category` on every line in `lines`. Lines that already have it are returned as they are; the rest are created in one transaction. The response has one entry per line, in request order, so calling this again is a no-op.  `category` may be given by `id` or `name` and must be one of your organization's own categories; Oden's built-in categories are read-only. `active` defaults to true and also re-activates an existing inactive reason (or deactivates with `false`).  Requires an organization admin token.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_state_reasons_with_http_info(state_reason_set, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method set_state_reasons" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'state_reason_set' is set
        if self.api_client.client_side_validation and ('state_reason_set' not in local_var_params or  # noqa: E501
                                                        local_var_params['state_reason_set'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `state_reason_set` when calling `set_state_reasons`")  # noqa: E501
        ...
        body_params = None
        if 'state_reason_set' in local_var_params:
            body_params = local_var_params['state_reason_set']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
