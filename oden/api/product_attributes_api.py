...
class ProductAttributesApi(object):
    ...
    def v2_product_attribute_search_post(self, product_attribute, **kwargs):  # noqa: E501
        ...
        :param ProductAttribute product_attribute: (required)
    ...
    def v2_product_attribute_search_post_with_http_info(self, product_attribute, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[ProductAttribute], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        body_params = None
        if 'product_attribute' in local_var_params:
            body_params = local_var_params['product_attribute']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            '/v2/product_attribute/search', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='list[ProductAttribute]',  # noqa: E501
