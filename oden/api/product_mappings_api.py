...
class ProductMappingsApi(object):
    ...
    def v2_product_mapping_search_post(self, product_mapping, **kwargs):  # noqa: E501
        ...
        :param ProductMapping product_mapping: (required)
    ...
    def v2_product_mapping_search_post_with_http_info(self, product_mapping, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[ProductMapping], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        body_params = None
        if 'product_mapping' in local_var_params:
            body_params = local_var_params['product_mapping']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            '/v2/product_mapping/search', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='list[ProductMapping]',  # noqa: E501
