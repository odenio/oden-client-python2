...
class IntervalsApi(object):
    ...
    def v2_intervals_update_post(self, interval_bulk_update, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param IntervalBulkUpdate interval_bulk_update: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def v2_intervals_update_post_with_http_info(self, interval_bulk_update, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'interval_bulk_update' in local_var_params:
            body_params = local_var_params['interval_bulk_update']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
