...
class MetricGroupsApi(object):
    ...
    def v2_metric_group_search_post(self, metric_group, **kwargs):  # noqa: E501
        ...
        :param MetricGroup metric_group: (required)
    ...
    def v2_metric_group_search_post_with_http_info(self, metric_group, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[MetricGroup], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if 'metric_group' in local_var_params:
            body_params = local_var_params['metric_group']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='list[MetricGroup]',  # noqa: E501
