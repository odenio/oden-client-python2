...
class MachineGroupsApi(object):
    ...
    def v2_factory_search_post(self, factory, **kwargs):  # noqa: E501
        ...
        :param Factory factory: (required)
    ...
    def v2_line_search_post_with_http_info(self, line, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[Line], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if 'line' in local_var_params:
            body_params = local_var_params['line']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
