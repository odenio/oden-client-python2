...
import oden
from oden.models.quality_test import QualityTest  # noqa: E501
from oden.rest import ApiException

class TestQualityTest(unittest.TestCase):
    """QualityTest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = oden.models.quality_test.QualityTest()  # noqa: E501
        if include_optional :
            return QualityTest(
                id = '0', 
                raw_data = None, 
                ...
                interval = oden.models.interval.Interval(
                    ...
                    metadata = null, 
                    match = 'unique', ), 
                quality_schema = oden.models.quality_schema.QualitySchema(
                    id = '23', 
                    factory = oden.models.factory.Factory(
                        id = '0', 
                        name = '0', 
