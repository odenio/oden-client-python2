...
import oden
from oden.api.metric_groups_api import MetricGroupsApi  # noqa: E501
from oden.rest import ApiException


class TestMetricGroupsApi(unittest.TestCase):
    """MetricGroupsApi unit test stubs"""

    def setUp(self):
        self.api = oden.api.metric_groups_api.MetricGroupsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_v2_metric_group_search_post(self):
        """Test case for v2_metric_group_search_post
