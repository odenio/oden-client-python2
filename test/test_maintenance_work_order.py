...
import oden
from oden.models.maintenance_work_order import MaintenanceWorkOrder  # noqa: E501
from oden.rest import ApiException

class TestMaintenanceWorkOrder(unittest.TestCase):
    """MaintenanceWorkOrder unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test MaintenanceWorkOrder
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.maintenance_work_order.MaintenanceWorkOrder()  # noqa: E501
        if include_optional :
    ...
    def testMaintenanceWorkOrder(self):
        """Test MaintenanceWorkOrder"""
