...
import oden
from oden.models.dashboard_execute_request import DashboardExecuteRequest  # noqa: E501
from oden.rest import ApiException

class TestDashboardExecuteRequest(unittest.TestCase):
    """DashboardExecuteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DashboardExecuteRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.dashboard_execute_request.DashboardExecuteRequest()  # noqa: E501
        if include_optional :
            return DashboardExecuteRequest(
                dashboard = oden.models.dashboard_execute_request_dashboard.DashboardExecuteRequest_dashboard(
                    id = '0', ), 
                range = oden.models.dashboard_execute_range.DashboardExecuteRange(
                    start = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    end = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    anchor = '0', 
                    offset = '0', 
                    timezone = '0', ), 
                filters = oden.models.dashboard_execute_filters.DashboardExecuteFilters(
                    lines = [
                        None
                        ], 
                    shifts = [
                    ...
                    states = oden.models.dashboard_execute_filters_states.DashboardExecuteFilters_states(
                        state_types = [
                            '0'
                            ], 
                        state_category_and_reasons = [
                            oden.models.dashboard_execute_filters_states_state_category_and_reasons.DashboardExecuteFilters_states_state_category_and_reasons(
                                state_category = 56, 
                                state_reason = '0', )
                            ], ), 
                    custom_intervals = [
                        oden.models.dashboard_execute_filters_custom_intervals.DashboardExecuteFilters_custom_intervals(
                            type = '0', 
                            value_contains = '0', )
                        ], )
            )
    ...
    def testDashboardExecuteRequest(self):
        """Test DashboardExecuteRequest"""
