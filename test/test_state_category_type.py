...
import oden
from oden.models.state_category_type import StateCategoryType  # noqa: E501
from oden.rest import ApiException

class TestStateCategoryType(unittest.TestCase):
    """StateCategoryType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test StateCategoryType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.state_category_type.StateCategoryType()  # noqa: E501
        if include_optional :
            return StateCategoryType(
            )
        else :
            return StateCategoryType(
        )

    def testStateCategoryType(self):
        """Test StateCategoryType"""
