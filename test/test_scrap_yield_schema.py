...
import oden
from oden.models.scrap_yield_schema import ScrapYieldSchema  # noqa: E501
from oden.rest import ApiException

class TestScrapYieldSchema(unittest.TestCase):
    """ScrapYieldSchema unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ScrapYieldSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.scrap_yield_schema.ScrapYieldSchema()  # noqa: E501
        if include_optional :
            return ScrapYieldSchema(
                id = '0', 
