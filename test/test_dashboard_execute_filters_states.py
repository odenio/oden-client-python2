...
import oden
from oden.models.dashboard_execute_filters_states import DashboardExecuteFiltersStates  # noqa: E501
from oden.rest import ApiException

class TestDashboardExecuteFiltersStates(unittest.TestCase):
    """DashboardExecuteFiltersStates unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DashboardExecuteFiltersStates
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.dashboard_execute_filters_states.DashboardExecuteFiltersStates()  # noqa: E501
        if include_optional :
            return DashboardExecuteFiltersStates(
                state_types = [
                    '0'
                    ], 
    ...
    def testDashboardExecuteFiltersStates(self):
        """Test DashboardExecuteFiltersStates"""
