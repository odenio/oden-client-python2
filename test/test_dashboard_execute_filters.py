...
import oden
from oden.models.dashboard_execute_filters import DashboardExecuteFilters  # noqa: E501
from oden.rest import ApiException

class TestDashboardExecuteFilters(unittest.TestCase):
    """DashboardExecuteFilters unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DashboardExecuteFilters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.dashboard_execute_filters.DashboardExecuteFilters()  # noqa: E501
        if include_optional :
            return DashboardExecuteFilters(
                lines = [
                    None
                    ], 
                shifts = [
    ...
    def testDashboardExecuteFilters(self):
        """Test DashboardExecuteFilters"""
