...
import oden
from oden.models.state_category_search import StateCategorySearch  # noqa: E501
from oden.rest import ApiException

class TestStateCategorySearch(unittest.TestCase):
    """StateCategorySearch unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test StateCategorySearch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.state_category_search.StateCategorySearch()  # noqa: E501
        if include_optional :
            return StateCategorySearch(
                id = 56, 
                name = '0'
            )
        else :
    ...
    def testStateCategorySearch(self):
        """Test StateCategorySearch"""
