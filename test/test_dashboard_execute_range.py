...
import oden
from oden.models.dashboard_execute_range import DashboardExecuteRange  # noqa: E501
from oden.rest import ApiException

class TestDashboardExecuteRange(unittest.TestCase):
    """DashboardExecuteRange unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DashboardExecuteRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.dashboard_execute_range.DashboardExecuteRange()  # noqa: E501
        if include_optional :
            return DashboardExecuteRange(
    ...
    def testDashboardExecuteRange(self):
        """Test DashboardExecuteRange"""
