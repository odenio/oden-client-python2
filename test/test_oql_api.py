...
import oden
from oden.api.oql_api import OQLApi  # noqa: E501
from oden.rest import ApiException


class TestOQLApi(unittest.TestCase):
    """OQLApi unit test stubs"""

    def setUp(self):
        self.api = oden.api.oql_api.OQLApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_v2_oql_query_post(self):
        """Test case for v2_oql_query_post
