...
import oden
from oden.models.dashboard_execute_request_dashboard import DashboardExecuteRequestDashboard  # noqa: E501
from oden.rest import ApiException

class TestDashboardExecuteRequestDashboard(unittest.TestCase):
    """DashboardExecuteRequestDashboard unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DashboardExecuteRequestDashboard
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.dashboard_execute_request_dashboard.DashboardExecuteRequestDashboard()  # noqa: E501
        if include_optional :
            return DashboardExecuteRequestDashboard(
                id = '0'
            )
        else :
            return DashboardExecuteRequestDashboard(
    ...
    def testDashboardExecuteRequestDashboard(self):
        """Test DashboardExecuteRequestDashboard"""
