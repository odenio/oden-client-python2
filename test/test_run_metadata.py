...
import oden
from oden.models.run_metadata import RunMetadata  # noqa: E501
from oden.rest import ApiException

class TestRunMetadata(unittest.TestCase):
    """RunMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = oden.models.run_metadata.RunMetadata()  # noqa: E501
        if include_optional :
            return RunMetadata(
                product = oden.models.product.Product(
                    id = '0', 
                    name = '0', 
                    match = 'unique', ), 
                target = oden.models.target.Target(
                    metric_group = oden.models.metric_group.MetricGroup(
                        name = '0', 
                        description = '0', 
                        id = '0', 
                        unit_kind_of_quantity = '0', 
                        match = 'unique', ), 
                    product = oden.models.product.Product(
                        id = '0', 
                        name = '0', ), 
