...
import oden
from oden.models.inline_response200_failed_intervals import InlineResponse200FailedIntervals  # noqa: E501
from oden.rest import ApiException

class TestInlineResponse200FailedIntervals(unittest.TestCase):
    """InlineResponse200FailedIntervals unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test InlineResponse200FailedIntervals
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.inline_response200_failed_intervals.InlineResponse200FailedIntervals()  # noqa: E501
        if include_optional :
            return InlineResponse200FailedIntervals(
                id = '0', 
                error = '0'
            )
        else :
    ...
    def testInlineResponse200FailedIntervals(self):
        """Test InlineResponse200FailedIntervals"""
