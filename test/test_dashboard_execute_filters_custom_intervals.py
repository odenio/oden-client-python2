...
import oden
from oden.models.dashboard_execute_filters_custom_intervals import DashboardExecuteFiltersCustomIntervals  # noqa: E501
from oden.rest import ApiException

class TestDashboardExecuteFiltersCustomIntervals(unittest.TestCase):
    """DashboardExecuteFiltersCustomIntervals unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DashboardExecuteFiltersCustomIntervals
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.dashboard_execute_filters_custom_intervals.DashboardExecuteFiltersCustomIntervals()  # noqa: E501
        if include_optional :
            return DashboardExecuteFiltersCustomIntervals(
                type = '0', 
                value_contains = '0'
            )
        else :
    ...
    def testDashboardExecuteFiltersCustomIntervals(self):
        """Test DashboardExecuteFiltersCustomIntervals"""
