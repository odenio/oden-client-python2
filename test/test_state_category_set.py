...
import oden
from oden.models.state_category_set import StateCategorySet  # noqa: E501
from oden.rest import ApiException

class TestStateCategorySet(unittest.TestCase):
    """StateCategorySet unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test StateCategorySet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.state_category_set.StateCategorySet()  # noqa: E501
        if include_optional :
            return StateCategorySet(
                id = 56, 
                name = '0', 
                type = 'uptime', 
                active = True
