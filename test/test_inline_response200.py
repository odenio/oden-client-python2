...
import oden
from oden.models.inline_response200 import InlineResponse200  # noqa: E501
...
class TestInlineResponse200(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = oden.models.inline_response200.InlineResponse200()  # noqa: E501
        if include_optional :
            return InlineResponse200(
                ...
                num_failed = 56, 
                failed_intervals = [
                    oden.models.inline_response_200_failed_intervals.inline_response_200_failed_intervals(
                        id = '0', 
                        error = '0', )
                    ]
            )
