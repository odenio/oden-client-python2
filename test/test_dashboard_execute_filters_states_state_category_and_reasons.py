...
import oden
from oden.models.dashboard_execute_filters_states_state_category_and_reasons import DashboardExecuteFiltersStatesStateCategoryAndReasons  # noqa: E501
from oden.rest import ApiException

class TestDashboardExecuteFiltersStatesStateCategoryAndReasons(unittest.TestCase):
    """DashboardExecuteFiltersStatesStateCategoryAndReasons unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DashboardExecuteFiltersStatesStateCategoryAndReasons
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.dashboard_execute_filters_states_state_category_and_reasons.DashboardExecuteFiltersStatesStateCategoryAndReasons()  # noqa: E501
        if include_optional :
            return DashboardExecuteFiltersStatesStateCategoryAndReasons(
                state_category = 56, 
                state_reason = '0'
            )
        else :
    ...
    def testDashboardExecuteFiltersStatesStateCategoryAndReasons(self):
        """Test DashboardExecuteFiltersStatesStateCategoryAndReasons"""
