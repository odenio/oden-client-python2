...
import oden
from oden.models.batch_metadata import BatchMetadata  # noqa: E501
...
class TestBatchMetadata(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = oden.models.batch_metadata.BatchMetadata()  # noqa: E501
        if include_optional :
            return BatchMetadata(
                run = oden.models.interval.Interval(
                    id = '0', 
