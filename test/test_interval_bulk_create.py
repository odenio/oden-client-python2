...
import oden
from oden.models.interval_bulk_create import IntervalBulkCreate  # noqa: E501
from oden.rest import ApiException

class TestIntervalBulkCreate(unittest.TestCase):
    """IntervalBulkCreate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IntervalBulkCreate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.interval_bulk_create.IntervalBulkCreate()  # noqa: E501
        if include_optional :
            return IntervalBulkCreate(
    ...
    def testIntervalBulkCreate(self):
        """Test IntervalBulkCreate"""
