...
import oden
from oden.models.interval_bulk_update import IntervalBulkUpdate  # noqa: E501
from oden.rest import ApiException

class TestIntervalBulkUpdate(unittest.TestCase):
    """IntervalBulkUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IntervalBulkUpdate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.interval_bulk_update.IntervalBulkUpdate()  # noqa: E501
        if include_optional :
            return IntervalBulkUpdate(
    ...
    def testIntervalBulkUpdate(self):
        """Test IntervalBulkUpdate"""
