...
import oden
from oden.models.dashboard_execute_result import DashboardExecuteResult  # noqa: E501
from oden.rest import ApiException

class TestDashboardExecuteResult(unittest.TestCase):
    """DashboardExecuteResult unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DashboardExecuteResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.dashboard_execute_result.DashboardExecuteResult()  # noqa: E501
        if include_optional :
            return DashboardExecuteResult(
                module_id = '0', 
                module_name = '0', 
                module_type = '0', 
                range = oden.models.dashboard_execute_result_range.DashboardExecuteResult_range(
                    start = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    end = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                filters_applied = { }, 
                columns = [
                    oden.models.dashboard_column_spec.DashboardColumnSpec(
                        name = '0', 
                        type = 'string', )
                    ], 
                rows = [
    ...
    def testDashboardExecuteResult(self):
        """Test DashboardExecuteResult"""
