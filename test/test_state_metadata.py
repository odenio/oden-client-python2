...
import oden
from oden.models.state_metadata import StateMetadata  # noqa: E501
from oden.rest import ApiException

class TestStateMetadata(unittest.TestCase):
    """StateMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = oden.models.state_metadata.StateMetadata()  # noqa: E501
        if include_optional :
            return StateMetadata(
                reason = oden.models.state_reason.StateReason(
                    id = 56, 
                    name = '0', ), 
                comment = '0', 
