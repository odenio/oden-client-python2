...
import oden
from oden.models.state_reason_detail import StateReasonDetail  # noqa: E501
from oden.rest import ApiException

class TestStateReasonDetail(unittest.TestCase):
    """StateReasonDetail unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test StateReasonDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.state_reason_detail.StateReasonDetail()  # noqa: E501
        if include_optional :
            return StateReasonDetail(
                id = 56, 
                name = '0', 
                active = True, 
    ...
    def testStateReasonDetail(self):
        """Test StateReasonDetail"""
