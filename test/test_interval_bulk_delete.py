...
import oden
from oden.models.interval_bulk_delete import IntervalBulkDelete  # noqa: E501
from oden.rest import ApiException

class TestIntervalBulkDelete(unittest.TestCase):
    """IntervalBulkDelete unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IntervalBulkDelete
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.interval_bulk_delete.IntervalBulkDelete()  # noqa: E501
        if include_optional :
            return IntervalBulkDelete(
    ...
    def testIntervalBulkDelete(self):
        """Test IntervalBulkDelete"""
