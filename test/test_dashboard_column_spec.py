...
import oden
from oden.models.dashboard_column_spec import DashboardColumnSpec  # noqa: E501
from oden.rest import ApiException

class TestDashboardColumnSpec(unittest.TestCase):
    """DashboardColumnSpec unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DashboardColumnSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.dashboard_column_spec.DashboardColumnSpec()  # noqa: E501
        if include_optional :
            return DashboardColumnSpec(
                name = '0', 
                type = 'string'
            )
        else :
    ...
    def testDashboardColumnSpec(self):
        """Test DashboardColumnSpec"""
