...
import oden
from oden.api.scrap_yield_data_api import ScrapYieldDataApi  # noqa: E501
from oden.rest import ApiException


class TestScrapYieldDataApi(unittest.TestCase):
    """ScrapYieldDataApi unit test stubs"""

    def setUp(self):
        self.api = oden.api.scrap_yield_data_api.ScrapYieldDataApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_v2_scrap_yield_delete_post(self):
        """Test case for v2_scrap_yield_delete_post

        """
        pass

    def test_v2_scrap_yield_search_post(self):
        """Test case for v2_scrap_yield_search_post

        """
        pass

    def test_v2_scrap_yield_set_post(self):
        """Test case for v2_scrap_yield_set_post
