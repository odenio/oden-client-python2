...
import oden
from oden.models.state_category_detail import StateCategoryDetail  # noqa: E501
from oden.rest import ApiException

class TestStateCategoryDetail(unittest.TestCase):
    """StateCategoryDetail unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test StateCategoryDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.state_category_detail.StateCategoryDetail()  # noqa: E501
        if include_optional :
    ...
    def testStateCategoryDetail(self):
        """Test StateCategoryDetail"""
