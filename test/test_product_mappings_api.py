...
import oden
from oden.api.product_mappings_api import ProductMappingsApi  # noqa: E501
from oden.rest import ApiException


class TestProductMappingsApi(unittest.TestCase):
    """ProductMappingsApi unit test stubs"""

    def setUp(self):
        self.api = oden.api.product_mappings_api.ProductMappingsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_v2_product_mapping_search_post(self):
        """Test case for v2_product_mapping_search_post

        """
        pass

    def test_v2_product_mapping_set_post(self):
        """Test case for v2_product_mapping_set_post
