...
import oden
from oden.models.oql_query import OQLQuery  # noqa: E501
from oden.rest import ApiException

class TestOQLQuery(unittest.TestCase):
    """OQLQuery unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = oden.models.oql_query.OQLQuery()  # noqa: E501
        if include_optional :
            return OQLQuery(
                query = '0'
            )
