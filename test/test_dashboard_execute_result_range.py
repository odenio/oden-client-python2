...
import oden
from oden.models.dashboard_execute_result_range import DashboardExecuteResultRange  # noqa: E501
from oden.rest import ApiException

class TestDashboardExecuteResultRange(unittest.TestCase):
    """DashboardExecuteResultRange unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DashboardExecuteResultRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.dashboard_execute_result_range.DashboardExecuteResultRange()  # noqa: E501
        if include_optional :
            return DashboardExecuteResultRange(
    ...
    def testDashboardExecuteResultRange(self):
        """Test DashboardExecuteResultRange"""
