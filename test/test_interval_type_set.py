...
import oden
from oden.models.interval_type_set import IntervalTypeSet  # noqa: E501
from oden.rest import ApiException

class TestIntervalTypeSet(unittest.TestCase):
    """IntervalTypeSet unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test IntervalTypeSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = oden.models.interval_type_set.IntervalTypeSet()  # noqa: E501
        if include_optional :
            return IntervalTypeSet(
                id = '0', 
                name = '0', 
                metadata_schema = '0', 
                tags = [
