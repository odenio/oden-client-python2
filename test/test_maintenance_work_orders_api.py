...
import oden
from oden.api.maintenance_work_orders_api import MaintenanceWorkOrdersApi  # noqa: E501
from oden.rest import ApiException


class TestMaintenanceWorkOrdersApi(unittest.TestCase):
    """MaintenanceWorkOrdersApi unit test stubs"""

    def setUp(self):
        self.api = oden.api.maintenance_work_orders_api.MaintenanceWorkOrdersApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_v2_maintenance_work_order_delete_post(self):
        """Test case for v2_maintenance_work_order_delete_post

        """
        pass

    def test_v2_maintenance_work_order_search_post(self):
        """Test case for v2_maintenance_work_order_search_post

        """
        pass

    def test_v2_maintenance_work_order_set_post(self):
        """Test case for v2_maintenance_work_order_set_post
